...
export function TwitterFollowCard({name = 'John Doe', userName ='johndoe', initialisFollowing = false}) {
    ...
    console.log(`Valor isFollowing de ${name}: ${initialisFollowing}`)
    ...
    // Sigue la nomenclatura de una condición terniaria: condición ? resultado si la condicón es true : resultado si la condición es false
